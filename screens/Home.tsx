...
const HomeScreen: React.FC<HomeProps> = ({ onNavigateToProfile, onCategoryClick, onProductClick, onAddToCart }) => {
            ...
            >
              <div className="relative aspect-[4/5] bg-gray-50 rounded-[2.5rem] overflow-hidden border border-gray-100 mb-4 shadow-sm group-hover:shadow-xl transition-all duration-500">
                ...
                <button 
                  ...
                  className="absolute top-4 right-4 bg-white/90 backdrop-blur-xl p-2.5 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-amber-50"
                  title="Add to Cart"
                >

  ...
  return (
    <div className="flex-1 bg-white overflow-y-auto pb-24">
      ...
      <div className="px-8 flex flex-col items-center mb-10">
        ...
        <h3 className="text-2xl font-semibold">Sarah Jenkins</h3>
        <p className="text-gray-400 text-sm">Elite Fashion Enthusiast</p>
      </div>
      ...
      <div className="px-6 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
           <div className="bg-gray-50 p-6 rounded-[2rem] border border-gray-100">
              <span className="block text-2xl font-black mb-1">12</span>
              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Saved Looks</span>
           </div>
           <div className="bg-gray-50 p-6 rounded-[2rem] border border-gray-100">
              <span className="block text-2xl font-black mb-1">48</span>
        ...
        <div className="pt-8 px-2">
          <button className="w-full py-4 text-red-500 font-bold text-xs uppercase tracking-widest border border-red-100 rounded-2xl hover:bg-red-50 transition-colors">
            Logout
          </button>
        </div>
      </div>
